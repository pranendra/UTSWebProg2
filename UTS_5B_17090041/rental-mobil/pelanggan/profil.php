    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            <?php if (isset($_SESSION["username"])): ?>
                <?php $id = $_SESSION["id"]; if ($query = $connection->query("SELECT * FROM user WHERE id=$id AND level = 'user'")): ?>
  ...
  <div class="col-md-8">
    <div class="row">
        <div class="panel panel-info">
          ...
          <div class="panel-body">
            <?php if ($query = $connection->query("SELECT * FROM transaksi JOIN user ON transaksi.id_pelanggan = user.id AND user.id = ".$_SESSION['id']."")): ?>
                <?php $no = 1; ?>
    ...
    <div class="row">
        <div class="panel panel-info">
          ...
          <div class="panel-body">
            <?php if ($query = $connection->query("SELECT * FROM transaksi JOIN user ON transaksi.id_pelanggan = user.id AND user.id = ".$_SESSION['id']." WHERE id_pelanggan=".$_SESSION['id']." AND denda <> ''")): ?>
                <?php $no = 1; ?>
                <table class="table table-hover">
                    <thead>
                        <tr>
