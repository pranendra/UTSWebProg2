	                    ...
	                    <?php if ($query = $connection->query("SELECT * FROM pelanggan")): ?>
	                        ...
	                        <tr>
	                            ...
	                            <td class="hidden-print">
	                                <div class="btn-group">
	                                    <a href="?page=pelanggan&action=update&key=<?=$row['id']?>" class="btn btn-warning btn-xs">Edit</a>
	                                    <a href="?page=pelanggan&action=delete&key=<?=$row['id']?>" class="btn btn-danger btn-xs">Hapus</a>
	                                </div>
	                            </td>
	                        </tr>
	                        <?php endwhile ?>
