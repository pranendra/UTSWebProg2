  ...
  <div class="panel panel-info">
    ...
    <div class="panel-body">
      <table class="table table-hover">
          <tbody>
							<?php $query = $connection->query("SELECT t.id_transaksi, m.nama_mobil, t.lama, t.jaminan, t.total_harga, t.tgl_sewa, t.tgl_ambil, t.tgl_kembali, t.jatuh_tempo, t.status, t.konfirmasi, t.pembatalan FROM transaksi t JOIN user p USING(id) JOIN mobil m ON t.id_mobil=m.id_mobil WHERE id_transaksi=$_GET[id]");?>
